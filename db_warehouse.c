...
int main()
{
    int a = db_warehouse_init();
    printf("\ncount value %d",count);
    int c = db_warehouse_create_product("pencil");
    printf("return value %d\ncount value %d",c,count);
    int d = db_warehouse_create_product("pen");
    printf("\ncount value %d",count);
    int e = db_warehouse_create_product("scale");
    printf("\ncount value %d",count);
    int f = db_warehouse_create_product("pen");
    printf("same product exists pen pritning return val %d",f);
    printf("\ncount value %d",count);
    db_printalldata();
    db_warehouse_delete_product("pen");
    db_printalldata();
    db_warehouse_update_stock("pencil", 99);
    db_printalldata();
    return 0;
}*/
